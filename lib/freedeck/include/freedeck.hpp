...
void load_encoders(uint16_t pageIndex);
...
void on_button_click(uint8_t buttonIndex, uint8_t secondary);
void on_turn_cw(uint8_t buttonIndex, uint8_t secondary);
void on_turn_ccw(uint8_t buttonIndex, uint8_t secondary);
